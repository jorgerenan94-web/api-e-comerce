...
router.post("/products", 
    authToken(["seller"]), 
    productsMiddleware.validadeCreateProduct, 
    productsController.createProduct)// Define a rota POST /products para criar um novo produto, usando o middleware de validação e o controlador createProduct
